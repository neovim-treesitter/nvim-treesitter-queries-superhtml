# nvim-treesitter-queries-superhtml

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-superhtml/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-superhtml/actions/workflows/validate.yml)

Neovim tree-sitter queries for **superhtml**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-superhtml",
...
- [ ] Changes are scoped to `superhtml` — do not include files for other languages
